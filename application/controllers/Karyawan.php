...
class Karyawan extends CI_Controller
{
  ...
  {
    if ($this->Karyawan_model->validation("savenew")) { // Jika validasi sukses atau hasil validasi adalah true
  ...
  {
    $sql = "SELECT kode_peran FROM karyawan WHERE username = 'eekrain' LIMIT 1";
